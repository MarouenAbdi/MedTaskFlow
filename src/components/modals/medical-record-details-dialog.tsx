			...
			<Dialog open={open} onOpenChange={onOpenChange}>
				<DialogContent className="max-w-4xl h-[90vh] overflow-hidden p-0 flex flex-col">
					...
					<div className="flex-1 overflow-y-auto px-6 py-4">
							...
							{!isEditMode ? (
								<>
									<Button
										...
										className="bg-amber-50 hover:bg-amber-100 dark:bg-amber-900/10 dark:hover:bg-amber-900/20 border-amber-200 dark:border-amber-800"
									>
						...
						{/* Top divider with consistent spacing */}
						<div className="my-5">
							<Separator />
						</div>
						...
						<div className="flex items-center gap-4 my-5">
							<Avatar className="w-16 h-16">
								{localRecord.avatar ? (
									<AvatarImage
										src={localRecord.avatar}
										alt={localRecord.patient}
									/>
								) : (
							...
							<div>
								...
								<div className="text-sm text-muted-foreground">
									Last Visit: {formatDate(localRecord.date)}
								</div>
							</div>
						...
						{/* Bottom divider with consistent spacing */}
						<div className="my-5">
							<Separator />
						</div>
