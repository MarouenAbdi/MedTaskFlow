...
import { Mic, FileText, Save, Copy, Trash2 } from "lucide-react";
    ...
    <Dialog open={open !== undefined ? open : isOpen} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="max-w-3xl max-h-[90vh] flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Record your session with {patientName}. The audio will be automatically transcribed and can be saved to the patient's medical record.
          </DialogDescription>
        </DialogHeader>
