...
const typeColors = {
  checkup: "bg-blue-100/90 text-blue-900 dark:bg-blue-900/30 dark:text-blue-200",
  followup: "bg-green-100/90 text-green-900 dark:bg-green-900/30 dark:text-green-200",
  consultation: "bg-purple-100/90 text-purple-900 dark:bg-purple-900/30 dark:text-purple-200",
  emergency: "bg-red-100/90 text-red-900 dark:bg-red-900/30 dark:text-red-200"
};

const badgeColors = {
  checkup: "bg-blue-50 text-blue-700 dark:bg-blue-900/20 dark:text-blue-300 border-blue-200 dark:border-blue-800",
  followup: "bg-green-50 text-green-700 dark:bg-green-900/20 dark:text-green-300 border-green-200 dark:border-green-800",
  consultation: "bg-purple-50 text-purple-700 dark:bg-purple-900/20 dark:text-purple-300 border-purple-200 dark:border-purple-800",
  emergency: "bg-red-50 text-red-700 dark:bg-red-900/20 dark:text-red-300 border-red-200 dark:border-red-800"
};
...
export function Appointments() {
  ...
  const handleSaveAppointment = (updatedAppointment: typeof appointments[0]) => {
