...
import { Star, Sparkles, CreditCard, Check, ArrowLeft, AlertTriangle, LogOut } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container max-w-7xl mx-auto py-8 px-4">
        ...
        <div className="space-y-8">
          <div>
            <h1 className="text-3xl font-bold tracking-tight mb-2">Manage Subscription</h1>
