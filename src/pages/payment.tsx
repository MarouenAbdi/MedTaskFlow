...
const planColors = {
  Standard: "bg-blue-100 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800",
  Premium: "bg-purple-100 dark:bg-purple-900/20 border-purple-200 dark:border-purple-800",
  Pro: "bg-amber-100 dark:bg-amber-900/20 border-amber-200 dark:border-amber-800"
};

// Official payment provider logos
const PAYMENT_LOGOS = {
  googlepay: "https://developers.google.com/static/pay/api/images/brand-guidelines/google-pay-mark.png",
  applepay: "https://developer.apple.com/assets/elements/badges/apple-pay-mark.svg",
  paypal: "https://www.paypalobjects.com/digitalassets/c/website/marketing/na/us/logo-center/Badge_2.png",
        ...
        <div className="space-y-6">
          ...
          <Card className={cn("border-2 px-4", planColors[selectedPlan.name])}>
            <CardHeader>
              ...
              <CardDescription>You are subscribing to the {selectedPlan.name} plan</CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <Tabs defaultValue="card" className="w-full">
                <TabsList className="grid w-full grid-cols-5 gap-4">
                  ...
                  <TabsTrigger value="googlepay">
                    ...
                    />
                    <span className="text-[#3c4043] dark:text-current ml-1">Pay</span>
                  </TabsTrigger>
                ...
                <TabsContent value="crypto" className="mt-4">
                  <div className="text-center py-8">
                    ...
                    <p className="text-lg font-medium">Pay with Cryptocurrency</p>
                    <p className="text-sm text-muted-foreground">
